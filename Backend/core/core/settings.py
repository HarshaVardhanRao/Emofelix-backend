...
ALLOWED_HOSTS = ["emofelix-backend.onrender.com", "emofelixapp.netlify.app", "127.0.0.1", "localhost", "emofelix.in", "emofelix.pythonanywhere.com"]
...
print(os.getenv('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET'))
LOGIN_URL = 'login'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'emofelix.ai@gmail.com'
EMAIL_HOST_PASSWORD = 'iqraxpjfzvkgeibo'
